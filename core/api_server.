        ...
        async def get_usage_analytics():
            ...
            return {
                ...
                "data": {
                    ...
                    "requests_remaining": 1000 - stats.get('generation_count', 0),
                    "reset_date": "2024-02-01T00:00:00Z",
                    "metrics": {
                        "total_generations": stats.get('generation_count', 0),
                        "success_rate": 0.94,
                        "average_processing_time": stats.get('average_generation_time', 0),
            ...
            async def process_single_image(image_file, index):
                async with semaphore:
                    try:
                        ...
                        # Process image
                        processed_bytes, image_info = self.image_processor.process_uploaded_image(wrapped_file)
